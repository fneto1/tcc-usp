...
public class KafkaConfig {
    ...
    //Publica os eventos em um tópico
    @Bean
    public KafkaTemplate<String, String> kafkaTemplate(ProducerFactory<String, String> producerFactory){
        return new KafkaTemplate<>(producerFactory);
    }

    //cria o tópico caso não esteja criado ainda
    ...
    @Bean
    public NewTopic paymentSuccessTopic() {return buildTopic(paymentSuccessTopic);}

    @Bean
    public NewTopic notifyEndingTopic() {return buildTopic(notifyEndingTopic);}
